...
# WeatherApp class handles the full UI and weather data interaction
class WeatherApp(QWidget):
    ...
    def initUT(self):
        ...
        # Apply CSS-like styling using Qt Style Sheets
        self.setStyleSheet("""
            QLabel, QPushButton {
                font-family: Arial;
            }
    ...
    def get_weather(self):
        # Enter your API key here (replace with your personal key)
        api_key = " "
        ...
        try:
            ...
            # If API returns success, display the weather info
            if data["cod"] == 200:
    ...
    # Convert and show weather data on the app
    ...
    # Return an emoji based on weather condition ID
    @staticmethod
